            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-4 justify-content-end">
                        <a href="{{ route('admin.pengurus.create') }}" class="btn my-bg text-white p-2 px-4"><i
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $data)
                                    <tr>
                                        ...
                                        {{-- {{dd($data->position)}} --}}
                                        <td class="text-center">{{ $data->position->position->name }}</td>

                                        <td class="text-center">
                                            <a href="{{ route('admin.pengurus.edit', [$data->id]) }}"
                                                class="btn my-bg text-white"><i class="fa fa-edit"></i></a>
                                            <form action="{{ route('admin.pengurus.destroy', [$data->id]) }}"
