...
@section('content')
    <main class="content">
        <div class="container p-0">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.cashflow.update', [$data->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ url('storage/cashflow/' . $data->image) }}" alt="Bukti" class="img-fluid">
                        </div>
                        <div class="mb-3">
                            <label for="image" class="form-label">Bukti</label>
