...
@section('content')
    <main class="content">
        <div class="container p-0">
            <h1 class="mb-3 fw-bold my-text-color">Kelola Jabatan</h1>
            @include('components.flash-message')
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-4 justify-content-end">
                        <a href="{{ route('admin.position.create') }}" class="btn my-bg text-white p-2 px-4"><i
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $data)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $data->positionUsers->count() }}</td>

                                        <td class="text-center">
                                            <a href="{{ route('admin.position.edit', [$data->id]) }}"
                                                class="btn my-bg text-white"><i class="fa fa-edit"></i></a>
                                            {{-- <form action="{{ route('admin.position.destroy', [$data->id]) }}"
